// @slack/web-api/dist/methods.d.ts, @slack/types/dist/index.d.ts からの転用
// とりあえず必要最小限のものだけを定義して使っている

export type PostMessageParams = Omit<ChatPostMessageArguments, "channel">;
...
export declare type KnownBlock =
  | ImageBlock
  | ContextBlock
  | ActionsBlock
  | DividerBlock
